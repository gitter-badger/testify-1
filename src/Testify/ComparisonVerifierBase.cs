...
namespace Testify
{
    ...
    public abstract class ComparisonVerifierBase<T>
        where T : IEquatable<T>
    {
        ...
        /// <summary>
        /// Gets the name of the verifier.
        /// </summary>
        /// <value>
        /// The name of the verifier.
        /// </value>
        protected abstract string VerifierName { get; }

        /// <summary>
        /// Verifies the specified type conforms to the contract.
        /// </summary>
        public void Verify()
        {
            try
            ...
            {
                Assertions.HandleFail(this.VerifierName, e, e.Message);
            }
        ...
        protected virtual IEnumerable<Action> GetTests()
        {
        ...
        {
            AssertAll(
                $"{this.VerifierName} failed.",
                this.GetTests().ToArray());
        }
